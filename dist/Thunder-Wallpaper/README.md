...
- `qa/verification.md` records the checks performed for this delivery. The project was also installed, opened in the native Wallpaper Engine editor, checked for all 18 user properties, applied to the desktop, and verified with the live web wallpaper renderer.
